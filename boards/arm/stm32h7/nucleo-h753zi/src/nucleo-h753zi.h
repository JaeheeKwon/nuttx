...
#define GPIO_NRF24L01_CE                                                       \
  (GPIO_OUTPUT | GPIO_SPEED_50MHz | GPIO_OUTPUT_CLEAR | GPIO_PORTF | GPIO_PIN12)
...
#define GPIO_MMCSD_CS                                                          \
  (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_OUTPUT_SET |          \
   GPIO_PORTD | GPIO_PIN15)
#define GPIO_MMCSD_NCD                                                         \
  (GPIO_INPUT | GPIO_PULLUP | GPIO_EXTI | GPIO_PORTF | GPIO_PIN12)
 ...
 *   USB-related GPIO pins for the NUCLEO-STM32H753ZI board.
 *
 ****************************************************************************/

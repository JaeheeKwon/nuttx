...
#  define HAVE_USB 1
#else
#  warning "CONFIG_STM32H5_OTGHS is enabled but neither CONFIG_USBDEV nor CONFIG_USBHOST"
#  undef HAVE_USB
#endif

#ifndef CONFIG_NUCLEO_H563ZI_USBHOST_PRIO
#  define CONFIG_NUCLEO_H563ZI_USBHOST_PRIO 100
#endif

#ifndef CONFIG_NUCLEO_H563ZI_USBHOST_STACKSIZE
#  define CONFIG_NUCLEO_H563ZI_USBHOST_STACKSIZE 1024
#endif
 ...
 *   USB-related GPIO pins for the STM32H563ZI Nucleo board.
 *
 ****************************************************************************/
  ...
  if (g_usbconn)
    {
      ...
      ret = kthread_create("usbhost", CONFIG_NUCLEO_H563ZI_USBHOST_PRIO,
                           CONFIG_NUCLEO_H563ZI_USBHOST_STACKSIZE,
                           usbhost_waiter, NULL);

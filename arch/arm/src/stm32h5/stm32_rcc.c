...
#  include "stm32h5x3xx_rcc.c"
#elif defined(CONFIG_STM32H5_STM32H5B3XX)
#  include "stm32h5x3xx_rcc.c"
#elif defined(CONFIG_STM32H5_STM32H5X5XX)
#  include "stm32h5x3xx_rcc.c"
#elif defined(CONFIG_STM32H5_STM32H5X7XX)
#  include "stm32h5x7xx_rcc.c"
#else
 ...
 *   configuration file.
 *
 *   If CONFIG_STM32H5_CUSTOM_CLOCKCONFIG is defined, then clocking will be
...
{
#ifndef CONFIG_STM32H5_BYPASS_CLOCKCONFIG
  /* Make sure that we are starting in the reset state */

  rcc_reset();

#  if defined(CONFIG_STM32H5_PWR)
...
#  if defined(CONFIG_STM32H5_CUSTOM_CLOCKCONFIG)
...
#  endif
#endif  /* !CONFIG_STM32H5_BYPASS_CLOCKCONFIG */

/****************************************************************************
 * arch/arm/src/stm32h5/stm32_qencoder.c
 *
...
#if defined(CONFIG_STM32H5_TIM2_QE) || defined(CONFIG_STM32H5_TIM5_QE)
#  define HAVE_32BIT_TIMERS   1
#endif

/* If TIM1,3,4, or 8 are enabled, then we have 16-bit timers */

#if defined(CONFIG_STM32H5_TIM1_QE) || defined(CONFIG_STM32H5_TIM3_QE) || \
    defined(CONFIG_STM32H5_TIM4_QE) || defined(CONFIG_STM32H5_TIM8_QE)
...
#ifdef CONFIG_STM32H5_QENCODER_FILTER
#  if defined(CONFIG_STM32H5_QENCODER_SAMPLE_FDTS)
#    if defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_1)
#      define STM32_QENCODER_ICF GTIM_CCMR_ICF_NOFILT
#    endif
#  elif defined(CONFIG_STM32H5_QENCODER_SAMPLE_CKINT)
#    if defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_2)
#      define STM32_QENCODER_ICF GTIM_CCMR_ICF_FCKINT2
#    elif defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_4)
#      define STM32_QENCODER_ICF GTIM_CCMR_ICF_FCKINT4
#    elif defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_8)
#      define STM32_QENCODER_ICF GTIM_CCMR_ICF_FCKINT8
#    endif
#  elif defined(CONFIG_STM32H5_QENCODER_SAMPLE_FDTS_2)
#    if defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_6)
#      define STM32_QENCODER_ICF GTIM_CCMR_ICF_FDTSd26
#    elif defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_8)
#      define STM32_QENCODER_ICF GTIM_CCMR_ICF_FDTSd28
#    endif
#  elif defined(CONFIG_STM32H5_QENCODER_SAMPLE_FDTS_4)
#    if defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_6)
#      define STM32_QENCODER_ICF GTIM_CCMR_ICF_FDTSd46
#    elif defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_8)
#      define STM32_QENCODER_ICF GTIM_CCMR_ICF_FDTSd48
#    endif
#  elif defined(CONFIG_STM32H5_QENCODER_SAMPLE_FDTS_8)
#    if defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_6)
#      define STM32_QENCODER_ICF GTIM_CCMR_ICF_FDTSd86
#    elif defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_8)
#      define STM32_QENCODER_ICF GTIM_CCMR_ICF_FDTSd88
#    endif
#  elif defined(CONFIG_STM32H5_QENCODER_SAMPLE_FDTS_16)
#    if defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_5)
#      define STM32_QENCODER_ICF GTIM_CCMR_ICF_FDTSd165
#    elif defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_6)
#      define STM32_QENCODER_ICF GTIM_CCMR_ICF_FDTSd166
#    elif defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_8)
#      define STM32_QENCODER_ICF GTIM_CCMR_ICF_FDTSd168
#    endif
#  elif defined(CONFIG_STM32H5_QENCODER_SAMPLE_FDTS_32)
#    if defined(CONFIG_STM32H5_QENCODER_SAMPLE_EVENT_5)
...
#if defined(CONFIG_STM32H5_TIM1_QE) || defined(CONFIG_STM32H5_TIM8_QE)

/****************************************************************************
 * arch/arm/src/stm32h5/stm32_fdcan_sock.c
 *
...
#  if defined(CONFIG_STM32H5_FDCAN_HPWORK)
#    define CANWORK HPWORK
#  elif defined(CONFIG_STM32H5_FDCAN_LPWORK)
...
#ifdef CONFIG_STM32H5_FDCAN3
#  error "FDCAN3 support not yet added to stm32h5x3xx header files (pinmap, irq, etc.)"
...
int fdcan_initialize(struct fdcan_driver_s *priv)
{
...
#ifdef CONFIG_STM32H5_FDCAN_LOOPBACK
...
#ifdef CONFIG_STM32H5_FDCAN_LOOPBACK_INTERNAL
   ...
   * 43c9e552ba1c038577c48723d96ca8c825b11987/Drivers/STM32H5xx_HAL_Driver/
   * Inc/stm32h5xx_hal_fdcan.h#L112-L113
   *
   * Discussion:

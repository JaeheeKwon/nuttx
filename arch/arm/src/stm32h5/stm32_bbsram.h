/****************************************************************************
 * arch/arm/src/stm32h5/stm32_bbsram.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H5_STM32_BBSRAM_H
#define __ARCH_ARM_SRC_STM32H5_STM32_BBSRAM_H

/****************************************************************************
 * The purpose of this driver is to add battery backup file to the file
 * system. There can be CONFIG_STM32H5_BBRSRAM_COUNT files defined.
...
#define STM32H5_BBSRAM_SIZE 4096

#if !defined(CONFIG_STM32H5_BBSRAM_FILES)
#  define CONFIG_STM32H5_BBSRAM_FILES 4
#endif

/* REVISIT: What guarantees that STM32H5_BBSRAM_GETDESC_IOCTL has a unique
 * value among all over _DIOC() values?
 */

#define STM32H5_BBSRAM_GETDESC_IOCTL _DIOC(0x0010) /* Returns a bbsramd_s */
 ...
 *
 * If the length of sizes is greater then CONFIG_STM32H5_BBSRAM_FILES
 * CONFIG_STM32H5_BBSRAM_FILES will be returned.
 *
 * Returned Value:
...
*
* Parameters:
*   fileno  - the value returned by the ioctl STM32H5_BBSRAM_GETDESC_IOCTL
...
#endif
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_ARM_SRC_STM32H5_STM32_BBSRAM_H */

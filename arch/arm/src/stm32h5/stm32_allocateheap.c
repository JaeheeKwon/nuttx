/****************************************************************************
 * arch/arm/src/stm32h5/stm32h5_allocateheap.c
 *
...
/* Internal SRAM is available in all members of the STM32H5 family. The
 ...
 *
 * CONFIG_STM32H5_FSMC=y      : Enables the FSMC
 * CONFIG_STM32H5_FSMC_SRAM=y : Indicates that SRAM is available via the
...
#ifndef CONFIG_STM32H5_FSMC
#  undef CONFIG_STM32H5_FSMC_SRAM
#endif

/* STM32H5[7,8]6xx have 128 Kib in two banks, both accessible to DMA:
 *
 ...
 *
 * STM32H596xx have 320 Kib in two banks, both accessible to DMA:
 *
 ...
 *
 * STM32H5Rxxx have 640 Kib in three banks:
 *
...
#if CONFIG_MM_REGIONS < defined(CONFIG_STM32H5_SRAM2_HEAP) + \
                        defined(CONFIG_STM32H5_SRAM3_HEAP) + \
                        defined(CONFIG_STM32H5_FSMC_SRAM_HEAP) + 1
...
#ifdef CONFIG_STM32H5_FSMC_SRAM
...
{
#ifdef CONFIG_STM32H5_SRAM2_HEAP
...
#ifdef CONFIG_STM32H5_SRAM3_HEAP
...
#ifdef CONFIG_STM32H5_FSMC_SRAM_HEAP
#if defined(CONFIG_BUILD_PROTECTED) && defined(CONFIG_MM_KERNEL_HEAP)

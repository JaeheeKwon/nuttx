/****************************************************************************
 * arch/arm/src/stm32h5/stm32_otg.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H5_STM32_OTG_H
#define __ARCH_ARM_SRC_STM32H5_STM32_OTG_H
...
#include "hardware/stm32_otg.h"
    ...
    !defined(CONFIG_STM32H5_HSI48)
#  error board.h selected HSI48 as USB clock source, but HSI48 is not \
         enabled. Enable STM32H5_HSI48
#endif

#if defined(CONFIG_STM32H5_OTGHS) && !defined(CONFIG_STM32H5_OTGHS_FS) && \
...
#  error OTG HS selected but no ULPI enabled
    ...
    !defined(CONFIG_STM32H5_SYSCFG_IOCOMPENSATION)
...
#ifdef CONFIG_STM32H5_OTGHS_EXTERNAL_ULPI
/****************************************************************************
...
#endif /* __ASSEMBLY__ */
#endif /* CONFIG_STM32H5_OTGFS */
#endif /* __ARCH_ARM_SRC_STM32H5_STM32_OTG_H */

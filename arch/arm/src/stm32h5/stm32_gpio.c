 ...
 */
    ...
    defined(CONFIG_STM32H5_STM32H5B3XX) || \
    defined(CONFIG_STM32H5_STM32H5X5XX) || \
    defined(CONFIG_STM32H5_STM32H5X7XX)

#if defined(CONFIG_STM32H5_USE_LEGACY_PINMAP)
#  pragma message "CONFIG_STM32H5_USE_LEGACY_PINMAP will be deprecated migrate board.h see tools/stm32_pinmap_tool.py"
#endif
...
/* GPIO A-I */
const uint32_t g_gpiobase[STM32H5_NGPIO] =
{
#if STM32H5_NGPIO > 0
  STM32_GPIOA_BASE,
#endif
...
#endif
#if STM32H5_NGPIO > 5
#  if defined(CONFIG_STM32H5_HAVE_GPIOF)
  STM32_GPIOF_BASE,
#  else
  0,
#  endif
#endif
#if STM32H5_NGPIO > 6
#  if defined(CONFIG_STM32H5_HAVE_GPIOG)
  STM32_GPIOG_BASE,
#  else
  0,
#  endif
...
#ifdef CONFIG_STM32H5_SYSCFG_IOCOMPENSATION
...
#endif /* CONFIG_STM32H5_STM32H5X3XX || CONFIG_STM32H5_STM32H5X7XX || CONFIG_STM32H5_STM32H5B3XX */

/****************************************************************************
 * arch/arm/src/stm32h5/stm32_usbhost.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H5_STM32_USBHOST_H
#define __ARCH_ARM_SRC_STM32H5_STM32_USBHOST_H
 ...
 *     or
 *  CONFIG_STM32H5_OTGHS  - Enable the STM32 USB OTG HS block
...
#if (defined(CONFIG_STM32H5_OTGFS) || defined(CONFIG_STM32H5_OTGHS)) && \
...
#endif /* __ASSEMBLY__ */
#endif /* (CONFIG_STM32H5_OTGFS || CONFIG_STM32H5_OTGHS) && CONFIG_USBHOST */
#endif /* __ARCH_ARM_SRC_STM32H5_STM32_USBHOST_H */

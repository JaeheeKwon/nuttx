...
#ifdef CONFIG_STM32H5_RTC_LSECLOCK_RUN_DRV_CAPABILITY
#  if CONFIG_STM32H5_RTC_LSECLOCK_RUN_DRV_CAPABILITY < 0 || \
      CONFIG_STM32H5_RTC_LSECLOCK_RUN_DRV_CAPABILITY > 3
#    error "Invalid LSE drive capability setting"
#  endif
#endif
...
void stm32_rcc_enablelse(void)
{
  ...
  if ((regval & (RCC_BDCR_LSEON | RCC_BDCR_LSERDY)) !=
                (RCC_BDCR_LSEON | RCC_BDCR_LSERDY))
    {
      ...
      regval |= drives[CONFIG_STM32H5_RTC_LSECLOCK_START_DRV_CAPABILITY];
...
#endif
#if defined(CONFIG_STM32H5_RTC_LSECLOCK_RUN_DRV_CAPABILITY) && \
    CONFIG_STM32H5_RTC_LSECLOCK_START_DRV_CAPABILITY != \
    CONFIG_STM32H5_RTC_LSECLOCK_RUN_DRV_CAPABILITY
      /* Set running drive capability for LSE oscillator. */

      regval &= ~RCC_BDCR_LSEDRV_MASK;
      regval |= drives[CONFIG_STM32H5_RTC_LSECLOCK_RUN_DRV_CAPABILITY];
      putreg32(regval, STM32_RCC_BDCR);
#endif

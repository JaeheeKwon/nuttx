/****************************************************************************
 * arch/arm/src/stm32h5/stm32_sdmmc.c
 *
...
#if defined(CONFIG_STM32H5_SDMMC1) || defined(CONFIG_STM32H5_SDMMC2)
 ...
 *   CONFIG_STM32H5_SDMMC_IDMA - Enable SDMMC IDMA.
 ...
 *     4 SD data lines).
 *   CONFIG_STM32H5_SDMMC_XFRDEBUG - Enables some very low-level debug
...
#if !defined(CONFIG_STM32H5_SDMMC1)
#  define SDMMC2_SLOT  0
#else
#  define SDMMC2_SLOT  1
#endif

#if !defined(CONFIG_STM32H5_SDMMC_IDMA)
#  warning "Large Non-DMA transfer may result in RX overrun failures"
#elif defined(CONFIG_STM32H5_SDMMC1)
#  define SRAM123_START STM32_SRAM123_BASE
#  define SRAM123_END   (SRAM123_START + STM32H5_SRAM123_SIZE)
#  define SRAM4_START   STM32_SRAM4_BASE
#  define SRAM4_END     (SRAM4_START + STM32H5_SRAM4_SIZE)
#endif
...
#  undef CONFIG_STM32H5_SDMMC_XFRDEBUG
#endif
...
#if defined(CONFIG_STM32H5_SDMMC_XFRDEBUG)
...
#ifndef CONFIG_STM32H5_SDMMC_IDMA
...
#endif
#if defined(CONFIG_STM32H5_SDMMC2)
...
#if defined(CONFIG_STM32H5_SDMMC_IDMA) && defined(CONFIG_ARCH_HAVE_SDIO_PREFLIGHT)
static int stm32_dmapreflight(struct sdio_dev_s *dev,
                              const uint8_t *buffer, size_t buflen)
{
  struct stm32_dev_s *priv = (struct stm32_dev_s *)dev;
...
#if defined(CONFIG_ARMV8M_DCACHE) && !defined(CONFIG_ARMV8M_DCACHE_WRITETHROUGH)
   ...
   * ARMV8M_DCACHE_LINESIZE boundaries.
   */

  if (buffer != priv->rxfifo &&
      (((uintptr_t)buffer & (ARMV8M_DCACHE_LINESIZE - 1)) != 0 ||
      ((uintptr_t)(buffer + buflen) & (ARMV8M_DCACHE_LINESIZE - 1)) != 0))
    {
                              ...
                              uint8_t *buffer, size_t buflen)
{
  ...
  if (((uintptr_t)buffer & (ARMV8M_DCACHE_LINESIZE - 1)) != 0 ||
       (buflen & (ARMV8M_DCACHE_LINESIZE - 1)) != 0)
    {
...
#endif /* CONFIG_STM32H5_SDMMC1 || CONFIG_STM32H5_SDMMC2 */

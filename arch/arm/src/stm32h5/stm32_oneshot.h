/****************************************************************************
 * arch/arm/src/stm32h5/stm32_oneshot.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H5_STM32_ONESHOT_H
#define __ARCH_ARM_SRC_STM32H5_STM32_ONESHOT_H
...
#ifdef CONFIG_STM32H5_ONESHOT

/****************************************************************************
 * Pre-processor Definitions
 ****************************************************************************/

#if !defined(CONFIG_STM32H5_ONESHOT_MAXTIMERS) || \
    CONFIG_STM32H5_ONESHOT_MAXTIMERS < 1
#  undef CONFIG_STM32H5_ONESHOT_MAXTIMERS
#  define CONFIG_STM32H5_ONESHOT_MAXTIMERS 1
#endif

#if CONFIG_STM32H5_ONESHOT_MAXTIMERS > 8
#  warning Additional logic required to handle more than 8 timers
#  undef CONFIG_STM32H5_ONESHOT_MAXTIMERS
#  define CONFIG_STM32H5_ONESHOT_MAXTIMERS 8
#endif
...
#if CONFIG_STM32H5_ONESHOT_MAXTIMERS > 1
...
#endif /* CONFIG_STM32H5_ONESHOT */
#endif /* __ARCH_ARM_SRC_STM32H5_STM32_ONESHOT_H */

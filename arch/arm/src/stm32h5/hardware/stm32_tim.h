...
#  define STM32_TIM2_AF1          (STM32_TIM2_BASE+STM32_ATIM_AF1_OFFSET)
#  define STM32_TIM2_AF2          (STM32_TIM2_BASE+STM32_ATIM_AF2_OFFSET)
#  define STM32_TIM2_TISEL        (STM32_TIM2_BASE+STM32_ATIM_TISEL_OFFSET)
...
#  define STM32_TIM3_AF1          (STM32_TIM3_BASE+STM32_ATIM_AF1_OFFSET)
#  define STM32_TIM3_AF2          (STM32_TIM3_BASE+STM32_ATIM_AF2_OFFSET)
#  define STM32_TIM3_TISEL        (STM32_TIM3_BASE+STM32_ATIM_TISEL_OFFSET)
...
#  define STM32_TIM4_AF1          (STM32_TIM4_BASE+STM32_ATIM_AF1_OFFSET)
#  define STM32_TIM4_AF2          (STM32_TIM4_BASE+STM32_ATIM_AF2_OFFSET)
#  define STM32_TIM4_TISEL        (STM32_TIM4_BASE+STM32_ATIM_TISEL_OFFSET)
...
#  define STM32_TIM5_AF1          (STM32_TIM5_BASE+STM32_ATIM_AF1_OFFSET)
#  define STM32_TIM5_AF2          (STM32_TIM5_BASE+STM32_ATIM_AF2_OFFSET)
#  define STM32_TIM5_TISEL        (STM32_TIM5_BASE+STM32_ATIM_TISEL_OFFSET)

/* 16-bit General Timers - TIM12-14 without dma */
...
#  define STM32_TIM12_TISEL        (STM32_TIM12_BASE+STM32_ATIM_TISEL_OFFSET)
...
#  define STM32_TIM13_TISEL        (STM32_TIM13_BASE+STM32_ATIM_TISEL_OFFSET)
...
#  define STM32_TIM14_TISEL        (STM32_TIM14_BASE+STM32_ATIM_TISEL_OFFSET)

/* 16-bit General Timers - TIM15-17 */
...
#  define STM32_TIM15_TISEL        (STM32_TIM15_BASE+STM32_ATIM_TISEL_OFFSET)
...
#  define STM32_TIM16_TISEL        (STM32_TIM16_BASE+STM32_ATIM_TISEL_OFFSET)
...
#  define STM32_TIM17_TISEL        (STM32_TIM17_BASE+STM32_ATIM_TISEL_OFFSET)

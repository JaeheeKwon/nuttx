...
#if defined(CONFIG_STM32H5_ADC1_OUTPUT_DFSDM) || \
    defined(CONFIG_STM32H5_ADC2_OUTPUT_DFSDM) || \
    defined(CONFIG_STM32H5_ADC3_OUTPUT_DFSDM)
#  define ADC_HAVE_DFSDM
#endif

#if defined(CONFIG_STM32H5_ADC1_OUTPUT_DFSDM)
#  define ADC1_HAVE_DFSDM 1
#  undef  CONFIG_STM32H5_ADC1_DMA
#else
#  undef  ADC1_HAVE_DFSDM
#endif

#if defined(CONFIG_STM32H5_ADC2_OUTPUT_DFSDM)
#  define ADC2_HAVE_DFSDM 1
#  undef  CONFIG_STM32H5_ADC2_DMA
#else
#  undef  ADC2_HAVE_DFSDM
#endif

#if defined(CONFIG_STM32H5_ADC3_OUTPUT_DFSDM)
#  define ADC3_HAVE_DFSDM 1
#  undef  CONFIG_STM32H5_ADC3_DMA
#else
...
#undef ADC_HAVE_DMA
    ...
    defined(CONFIG_STM32H5_ADC3_DMA)
...
#ifdef CONFIG_STM32H5_ADC2_DMA
#  define ADC2_HAVE_DMA 1
#else
#  undef  ADC2_HAVE_DMA
#endif

#ifdef CONFIG_STM32H5_ADC3_DMA
...
#if defined(CONFIG_STM32H5_TIM1_ADC3)
...
#elif defined(CONFIG_STM32H5_TIM2_ADC3)
#    define ADC3_HAVE_TIMER           1
...
#elif defined(CONFIG_STM32H5_TIM3_ADC3)
#    define ADC3_HAVE_TIMER           1
...
#elif defined(CONFIG_STM32H5_TIM4_ADC3)
#    define ADC3_HAVE_TIMER           1
...
#elif defined(CONFIG_STM32H5_TIM6_ADC3)
#    define ADC3_HAVE_TIMER           1
...
#elif defined(CONFIG_STM32H5_TIM8_ADC3)
#    define ADC3_HAVE_TIMER           1
...
#elif defined(CONFIG_STM32H5_TIM15_ADC3)
#    define ADC3_HAVE_TIMER           1
...
#  ifndef CONFIG_STM32H5_ADC3_SAMPLE_FREQUENCY
#    error "CONFIG_STM32H5_ADC3_SAMPLE_FREQUENCY not defined"
#  endif
#  ifndef CONFIG_STM32H5_ADC3_TIMTRIG
#    error "CONFIG_STM32H5_ADC3_TIMTRIG not defined"
#    warning "Values 0:CC1 1:CC2 2:CC3 3:CC4 4:TRGO"
#  endif
#endif
...
#  else
#    error "CONFIG_STM32H5_ADC1_TIMTRIG is out of range"
#  endif
#elif defined(CONFIG_STM32H5_TIM2_ADC1)
#  if CONFIG_STM32H5_ADC1_TIMTRIG == 0
...
#  else
#    error "CONFIG_STM32H5_ADC2_TIMTRIG is out of range"
#  endif
#elif defined(CONFIG_STM32H5_TIM2_ADC2)
#  if CONFIG_STM32H5_ADC2_TIMTRIG == 0

...
#if defined(CONFIG_STM32H5_LPTIM1)  || defined(CONFIG_STM32H5_LPTIM2)  || \
    defined(CONFIG_STM32H5_LPTIM3)  || defined(CONFIG_STM32H5_LPTIM4)  || \
    defined(CONFIG_STM32H5_LPTIM5)
...
#endif /* defined(CONFIG_STM32H5_LPTIM1 || ... || CONFIG_STM32H5_LPTIM5) */

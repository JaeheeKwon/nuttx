...
#define STM32_NSERIAL (STM32H5_NUSART + STM32H5_NUART)
...
#    endif
#    if DMAMAP_USART1_RX == DMAMAP_DMA12_USART1RX_0 && !defined(CONFIG_STM32H5_DMA1)
#        error STM32 USART1 using DMAMAP_DMA12_USART1RX_0 for receive DMA requires CONFIG_STM32H5_DMA1
#    endif
#    if DMAMAP_USART1_RX == DMAMAP_DMA12_USART1RX_1 && !defined(CONFIG_STM32H5_DMA2)
#        error STM32 USART1 using DMAMAP_DMA12_USART1RX_1 for receive DMA requires CONFIG_STM32H5_DMA2
#    endif
#  endif
...
#    endif
#    if DMAMAP_USART2_RX == DMAMAP_DMA12_USART2RX_0 && !defined(CONFIG_STM32H5_DMA1)
#        error STM32 USART2 using DMAMAP_DMA12_USART2RX_0 for receive DMA requires CONFIG_STM32H5_DMA1
#    endif
#    if DMAMAP_USART2_RX == DMAMAP_DMA12_USART2RX_1 && !defined(CONFIG_STM32H5_DMA2)
#        error STM32 USART2 using DMAMAP_DMA12_USART2RX_1 for receive DMA requires CONFIG_STM32H5_DMA2
#    endif
#  endif
...
#    endif
#    if DMAMAP_USART3_RX == DMAMAP_DMA12_USART3RX_0 && !defined(CONFIG_STM32H5_DMA1)
#        error STM32 USART3 using DMAMAP_DMA12_USART3RX_0 for receive DMA requires CONFIG_STM32H5_DMA1
#    endif
#    if DMAMAP_USART3_RX == DMAMAP_DMA12_USART3RX_1 && !defined(CONFIG_STM32H5_DMA2)
#        error STM32 USART3 using DMAMAP_DMA12_USART3RX_1 for receive DMA requires CONFIG_STM32H5_DMA2
#    endif
#  endif
...
#    endif
#    if DMAMAP_UART4_RX == DMAMAP_DMA12_UART4RX_0 && !defined(CONFIG_STM32H5_DMA1)
#        error STM32 UART4 using DMAMAP_DMA12_UART4RX_0 for receive DMA requires CONFIG_STM32H5_DMA1
#    endif
#    if DMAMAP_UART4_RX == DMAMAP_DMA12_UART4RX_1 && !defined(CONFIG_STM32H5_DMA2)
#        error STM32 UART4 using DMAMAP_DMA12_UART4RX_1 for receive DMA requires CONFIG_STM32H5_DMA2
#    endif
#  endif
...
#    endif
#    if DMAMAP_UART5_RX == DMAMAP_DMA12_UART5RX_0 && !defined(CONFIG_STM32H5_DMA1)
#        error STM32 UART5 using DMAMAP_DMA12_UART5RX_0 for receive DMA requires CONFIG_STM32H5_DMA1
#    endif
#    if DMAMAP_UART5_RX == DMAMAP_DMA12_UART5RX_1 && !defined(CONFIG_STM32H5_DMA2)
#        error STM32 UART5 using DMAMAP_DMA12_UART5RX_1 for receive DMA requires CONFIG_STM32H5_DMA2
#    endif
#  endif
...
#    endif
#    if DMAMAP_USART6_RX == DMAMAP_DMA12_USART6RX_0 && !defined(CONFIG_STM32H5_DMA1)
#        error STM32 USART6 using DMAMAP_DMA12_USART6RX_0 for receive DMA requires CONFIG_STM32H5_DMA1
#    endif
#    if DMAMAP_USART6_RX == DMAMAP_DMA12_USART6RX_1 && !defined(CONFIG_STM32H5_DMA2)
#        error STM32 USART6 using DMAMAP_DMA12_USART6RX_1 for receive DMA requires CONFIG_STM32H5_DMA2
#    endif
#  endif
 ...
 *
 * Should there be a Cortex-M7 without a D-Cache, ARMV8M_DCACHE_LINESIZE
 * would be zero!
 */
...
#  if !defined(CONFIG_STM32H5_SERIAL_RXDMA_BUFFER_SIZE) || \
      (CONFIG_STM32H5_SERIAL_RXDMA_BUFFER_SIZE < ARMV8M_DCACHE_LINESIZE)
#    undef CONFIG_STM32H5_SERIAL_RXDMA_BUFFER_SIZE
#    define CONFIG_STM32H5_SERIAL_RXDMA_BUFFER_SIZE ARMV8M_DCACHE_LINESIZE
#  endif

#  define RXDMA_BUFFER_MASK   (ARMV8M_DCACHE_LINESIZE - 1)
#  define RXDMA_BUFFER_SIZE   ((CONFIG_STM32H5_SERIAL_RXDMA_BUFFER_SIZE \
...
#    endif
#    if DMAMAP_USART1_TX == DMAMAP_DMA12_USART1TX_0 && !defined(CONFIG_STM32H5_DMA1)
#        error STM32 USART1 using DMAMAP_DMA12_USART1TX_0 for transmit DMA requires CONFIG_STM32H5_DMA1
#    endif
#    if DMAMAP_USART1_TX == DMAMAP_DMA12_USART1TX_1 && !defined(CONFIG_STM32H5_DMA2)
#        error STM32 USART1 using DMAMAP_DMA12_USART1TX_1 for transmit DMA requires CONFIG_STM32H5_DMA2
#    endif
#  endif
...
#    endif
#    if DMAMAP_USART2_TX == DMAMAP_DMA12_USART2TX_0 && !defined(CONFIG_STM32H5_DMA1)
#        error STM32 USART2 using DMAMAP_DMA12_USART2TX_0 for transmit DMA requires CONFIG_STM32H5_DMA1
#    endif
#    if DMAMAP_USART2_TX == DMAMAP_DMA12_USART2TX_1 && !defined(CONFIG_STM32H5_DMA2)
#        error STM32 USART2 using DMAMAP_DMA12_USART2TX_1 for transmit DMA requires CONFIG_STM32H5_DMA2
#    endif
#  endif
...
#    endif
#    if DMAMAP_USART3_TX == DMAMAP_DMA12_USART3TX_0 && !defined(CONFIG_STM32H5_DMA1)
#        error STM32 USART3 using DMAMAP_DMA12_USART3TX_0 for transmit DMA requires CONFIG_STM32H5_DMA1
#    endif
#    if DMAMAP_USART3_TX == DMAMAP_DMA12_USART3TX_1 && !defined(CONFIG_STM32H5_DMA2)
#        error STM32 USART3 using DMAMAP_DMA12_USART3TX_1 for transmit DMA requires CONFIG_STM32H5_DMA2
#    endif
#  endif
...
#    endif
#    if DMAMAP_UART4_TX == DMAMAP_DMA12_UART4TX_0 && !defined(CONFIG_STM32H5_DMA1)
#        error STM32 UART4 using DMAMAP_DMA12_UART4TX_0 for transmit DMA requires CONFIG_STM32H5_DMA1
#    endif
#    if DMAMAP_UART4_TX == DMAMAP_DMA12_UART4TX_1 && !defined(CONFIG_STM32H5_DMA2)
#        error STM32 UART4 using DMAMAP_DMA12_UART4TX_1 for transmit DMA requires CONFIG_STM32H5_DMA2
#    endif
#  endif
...
#    endif
#    if DMAMAP_UART5_TX == DMAMAP_DMA12_UART5TX_0 && !defined(CONFIG_STM32H5_DMA1)
#        error STM32 UART5 using DMAMAP_DMA12_UART5TX_0 for transmit DMA requires CONFIG_STM32H5_DMA1
#    endif
#    if DMAMAP_UART5_TX == DMAMAP_DMA12_UART5TX_1 && !defined(CONFIG_STM32H5_DMA2)
#        error STM32 UART5 using DMAMAP_DMA12_UART5TX_1 for transmit DMA requires CONFIG_STM32H5_DMA2
#    endif
#  endif
...
#    endif
#    if DMAMAP_USART6_TX == DMAMAP_DMA12_USART6TX_0 && !defined(CONFIG_STM32H5_DMA1)
#        error STM32 USART6 using DMAMAP_DMA12_USART6TX_0 for transmit DMA requires CONFIG_STM32H5_DMA1
#    endif
#    if DMAMAP_USART6_TX == DMAMAP_DMA12_USART6TX_1 && !defined(CONFIG_STM32H5_DMA2)
#        error STM32 USART6 using DMAMAP_DMA12_USART6TX_1 for transmit DMA requires CONFIG_STM32H5_DMA2
#    endif
#  endif
...
#define TXDMA_BUFFER_SIZE   ((CONFIG_STM32H5_SERIAL_RXDMA_BUFFER_SIZE \
                              + RXDMA_BUFFER_MASK) & ~RXDMA_BUFFER_MASK)
...
#  warning stm32h5 serial power managemnt was taken from stm32f7 and is untested!
#endif
...
#if defined(CONFIG_STM32H5_FLOWCONTROL_BROKEN) && \
    !defined(CONFIG_SERIAL_IFLOWCONTROL_WATERMARKS)
#  error "CONFIG_STM32H5_FLOWCONTROL_BROKEN requires \
          CONFIG_SERIAL_IFLOWCONTROL_WATERMARKS to be enabled."
#endif

#ifndef CONFIG_STM32H5_FLOWCONTROL_BROKEN
...
#endif /* CONFIG_STM32H5_FLOWCONTROL_BROKEN */
...
static void up_pm_setsuspend(bool suspend)
{
  ...
  for (n = 0; n < STM32H5_NUSART + STM32H5_NUART; n++)
    {
...
static int up_ioctl(struct file *filep, int cmd, unsigned long arg)
{
    ...
    || defined(CONFIG_STM32H5_USART_SINGLEWIRE) \
    || defined(CONFIG_STM32H5_SERIALBRK_BSDCOMPAT)

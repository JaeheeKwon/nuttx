/****************************************************************************
 * arch/arm/src/stm32h5/stm32_otgdev.c
 *
...
#if defined(CONFIG_USBDEV) && (defined(CONFIG_STM32H5_OTGFS) || \
    defined(CONFIG_STM32H5_OTGHS))
...
#if defined(CONFIG_STM32H5_OTGFS_USBDEV)
...
#elif defined(CONFIG_STM32H5_OTGHS_USBDEV)
...
#if defined(CONFIG_STM32H5_OTGFS_USBDEV) && defined(CONFIG_STM32H5_OTGHS_USBDEV)
...
#if defined(CONFIG_STM32H5_USBDEV_REGDEBUG) && defined(CONFIG_DEBUG_FEATURES)
...
#if defined(CONFIG_STM32H5_OTGHS_USBDEV) &&     \
    defined(CONFIG_STM32H5_OTGHS_EXTERNAL_ULPI)
...
#if (defined(CONFIG_STM32H5_OTGHS_USBDEV) &&                            \
     defined(CONFIG_STM32H5_OTGHS_NO_ULPI)) ||                          \
  defined(CONFIG_STM32H5_OTGFS_USBDEV)
...
#if defined(CONFIG_STM32H5_OTGHS_USBDEV) &&       \
    defined(CONFIG_STM32H5_OTGHS_FS) &&           \
    defined(CONFIG_STM32H5_OTGHS_EXTERNAL_ULPI)
...
#if defined(CONFIG_STM32H5_OTGHS_EXTERNAL_ULPI)
      priv->usbdev.speed = USB_SPEED_HIGH;
#else
      priv->usbdev.speed = USB_SPEED_FULL;
#endif
...
#endif /* CONFIG_USBDEV && CONFIG_STM32H5_OTGDEV */

/****************************************************************************
 * arch/arm/src/stm32h5/stm32_rtc.c
 *
...
#ifndef CONFIG_STM32H5_PWR
#  error "CONFIG_STM32H5_PWR must selected to use this driver"
#endif

/* Constants ****************************************************************/

#if defined(CONFIG_STM32H5_RTC_HSECLOCK)
#  define  RCC_BDCR_RTCSEL RCC_BDCR_RTCSEL_HSE
#elif defined(CONFIG_STM32H5_RTC_LSICLOCK)
#  define  RCC_BDCR_RTCSEL RCC_BDCR_RTCSEL_LSI
#elif defined(CONFIG_STM32H5_RTC_LSECLOCK)
...
int up_rtc_initialize(void)
{
   ...
   * unconditionally in stm32h5xxx_rcc.c on power up.  This done
...
#else /* CONFIG_STM32H5_HAVE_RTC_SUBSECONDS */
...
#  ifndef CONFIG_STM32H5_HAVE_RTC_SUBSECONDS
#    error "Invalid config, enable CONFIG_STM32H5_HAVE_RTC_SUBSECONDS."
#  endif

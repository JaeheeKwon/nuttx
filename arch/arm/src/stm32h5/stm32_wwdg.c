/****************************************************************************
 * arch/arm/src/stm32h5/stm32_wwdg.c
 *
...
#if defined(CONFIG_WATCHDOG) && defined(CONFIG_STM32H5_WWDG)
...
#ifndef CONFIG_STM32H5_WWDG_DEFTIMOUT
#  define CONFIG_STM32H5_WWDG_DEFTIMOUT WWDG_MAXTIMEOUT
#endif

#ifndef CONFIG_DEBUG_WATCHDOG_INFO
#  undef CONFIG_STM32H5_WWDG_REGDEBUG
#endif
...
#ifdef CONFIG_STM32H5_WWDG_REGDEBUG
...
#endif /* CONFIG_WATCHDOG && CONFIG_STM32H5_WWDG */

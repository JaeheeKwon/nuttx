...
#if defined(CONFIG_WATCHDOG) && defined(CONFIG_STM32H5_IWDG)
...
#ifndef CONFIG_STM32H5_IWDG_DEFTIMOUT
#  define CONFIG_STM32H5_IWDG_DEFTIMOUT IWDG_MAXTIMEOUT
#endif

#ifndef CONFIG_DEBUG_WATCHDOG_INFO
#  undef CONFIG_STM32H5_IWDG_REGDEBUG
#endif
...
#define CONFIG_STM32H5_IWDG_ONETIMESETUP 1
...
#undef CONFIG_STM32H5_IWDG_DEFERREDSETUP

/* But you can only try one at a time */

#if defined(CONFIG_STM32H5_IWDG_ONETIMESETUP) && defined(CONFIG_STM32H5_IWDG_DEFERREDSETUP)
#  error "Both CONFIG_STM32H5_IWDG_ONETIMESETUP and CONFIG_STM32H5_IWDG_DEFERREDSETUP are defined"
#endif
...
#ifdef CONFIG_STM32H5_IWDG_REGDEBUG
...
#ifndef CONFIG_STM32H5_IWDG_ONETIMESETUP
...
#ifdef CONFIG_STM32H5_IWDG_ONETIMESETUP
  if (priv->started)
    {
...
#ifndef CONFIG_STM32H5_IWDG_ONETIMESETUP
  /* If CONFIG_STM32H5_IWDG_DEFERREDSETUP is selected, then perform the
   * register configuration only if the timer has been started.
   */

#ifdef CONFIG_STM32H5_IWDG_DEFERREDSETUP
  if (priv->started)
#endif
    {
      stm32_setprescaler(priv);
...
#if defined(CONFIG_STM32H5_JTAG_FULL_ENABLE) || \
    defined(CONFIG_STM32H5_JTAG_NOJNTRST_ENABLE) || \
    defined(CONFIG_STM32H5_JTAG_SW_ENABLE)
    {
...
#endif /* CONFIG_WATCHDOG && CONFIG_STM32H5_IWDG */
